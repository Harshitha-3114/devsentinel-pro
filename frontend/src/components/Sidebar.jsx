...
const RESEARCH_LINKS = [
  { path: "/research", label: "LLM Benchmark", icon: <FlaskConical size={16} /> },
  { path: "/closed-loop-impact", label: "Closed Loop Impact", icon: <RefreshCw size={16} /> },
  { path: "/architecture-decisions", label: "Architecture ADRs", icon: <BookOpen size={16} /> },
]
