    ...
    <div className="text-black">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-4xl font-bold">Closed Loop Impact Analysis</h1>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 max-w-4xl mb-6">
        <label className="text-gray-500 text-sm mb-2 block font-medium">
          Feature Request — same request sent both with and without closed loop
        </label>
        <textarea
        ...
        {loading && (
          <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4">
            <p className="text-gray-600 text-sm font-medium mb-1">
              ⏳ Experiment running — 3 phases in progress
            </p>
        ...
        <div className="max-w-4xl">
          ...
          <div className="bg-black text-white rounded-xl p-6 mb-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-1">
                  {result.with_closed_loop.production_ready === "YES" ? "✅" : "⚠️"}
                </div>
                <div className="text-gray-300 text-sm">
            ...
            <div className="mt-4 pt-4 border-t border-gray-700">
              <p className="text-gray-300 text-sm">
                💡 <strong>Insight:</strong> {result.impact.verdict}
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              improving code quality by <strong>{result.impact.quality_improvement_percent}%</strong> and
              fixing <strong>{result.impact.vulnerabilities_fixed} security issues</strong> without
              human intervention. This validates the core hypothesis that closed loop
              feedback in AI development pipelines produces measurably more secure output.
            </p>
          </div>
        </div>
      )}
