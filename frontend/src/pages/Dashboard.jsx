...
// const COLOR_MAP = {
//   blue: "border-gray-700 hover:border-blue-500 hover:bg-blue-950",
//   indigo: "border-gray-700 hover:border-indigo-500 hover:bg-indigo-950",
//   red: "border-gray-700 hover:border-red-500 hover:bg-red-950",
//   green: "border-gray-700 hover:border-green-500 hover:bg-green-950",
//   purple: "border-gray-700 hover:border-purple-500 hover:bg-purple-950",
//   yellow: "border-gray-700 hover:border-yellow-500 hover:bg-yellow-950",
// }
...
//       className={`bg-gray-900 border rounded-xl p-6 cursor-pointer transition ${COLOR_MAP[feature.color]}`}
//     >
...
//       {/* Header */}
//       <div className="mb-8">
//         <h1 className="text-4xl font-bold mb-2">Welcome to DevSentinel Pro</h1>
...
//         {[
//           { label: "Analyze Features", value: "5", icon: "🔍" },
//           { label: "AI Agents", value: "4", icon: "🤖" },
//           { label: "Closed Loop", value: "Active", icon: "🔄" },
