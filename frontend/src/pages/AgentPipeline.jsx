...
//       <div className="flex items-center gap-1 mb-8 overflow-x-auto pb-2 flex-wrap">
...
//                 {step.label}
//               </span>
//               {result && <span className="text-green-400 text-xs">✓</span>}
//             </div>
...
//       {/* Closed Loop Label */}
//       <div className="mb-6 inline-flex items-center gap-2 bg-red-950 border border-red-700 px-4 py-2 rounded-lg text-sm text-red-300">
//         🔄 DevSentinel Closed Loop Active — Generated code is automatically scanned and reviewed
//       </div>

//       {/* Input */}
//       <div className="bg-gray-900 rounded-xl p-6 max-w-4xl mb-6">
...
//           placeholder="Describe the feature you want to build... e.g. Build a REST API for a todo app with CRUD operations, user authentication, and PostgreSQL database"
//           rows={4}
//           className="w-full bg-gray-800 text-white rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500 resize-none mb-4"
//         />
//         <button
...
//               ⏳ Pipeline Running — Please wait 60-90 seconds
//             </p>
//             <p className="text-gray-1000 text-xs">
//               Architect → Developer → Tester → DevSentinel Scan → Code Review → Reviewer Fix
//             </p>
//           </div>
//         )}
//       </div>
...
//       {error && (
//         <div className="bg-red-900 text-red-300 rounded-xl p-4 max-w-4xl mb-6">
//           {error}
//         </div>
//       )}
...
//           {/* Success Banner */}
//           <div className="mb-4 bg-green-900 border border-green-600 rounded-xl p-4 flex items-center gap-3">
...
//                 Code was built, scanned for vulnerabilities, reviewed, and fixed automatically
//               </p>
//             </div>
//           </div>
